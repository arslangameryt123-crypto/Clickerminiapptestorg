...
const adNetwork = {
    ...
    showInterstitial: function() {
        ...
        // YOUR INTERSTITIAL AD CODE GOES HERE
        show_9795096({
            type: 'inApp',
            inAppSettings: {
                frequency: 2,
            ...
            // You can add any post-ad logic here if needed
        }).catch((error) => {
            console.error('Interstitial ad failed to load:', error);
            // Fallback to simulated interstitial if the real ad fails
    ...
    showRewarded: function() {
        ...
        // YOUR REWARDED AD CODE GOES HERE
        show_9795096().then(() => {
            ...
            // Close the rewarded ad overlay if it's open
            document.getElementById('rewarded-ad').classList.add('hidden');
        }).catch((error) => {
            console.error('Ad failed to load:', error);
            // Fallback to simulated ad if the real ad fails
            this.showSimulatedRewardedAd();
        });
    },
    
    // Fallback simulated rewarded ad
    showSimulatedRewardedAd: function() {
    ...
    showPop: function() {
        ...
        // YOUR POP AD CODE GOES HERE
        show_9795096('pop').then(() => {
            // user watch ad till the end or close it in interstitial format
            // your code to reward user for rewarded format
            console.log("Pop ad completed");
            // You can add reward logic here if needed
        }).catch(e => {
            // user get error during playing ad
            // do nothing or whatever you want
            console.error('Pop ad failed to load:', e);
            // Fallback to simulated pop if the real ad fails
